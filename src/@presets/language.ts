...
const de = {
    ...
    mapsAccept: 'Karte anzeigen',
    mapsDirections: 'Routenplaner',
...
const en: Dictionary = {
    ...
    titleSleep: 'Sleep',
    mapsCookies: 'To view the map, you must agree to the <%a%>privacy<%/a%>. Otherwise you can also use the following <%a%>link<%/a%>.',
    mapsAccept: 'View map',
