...
const de = {
    ...
    titleSleep: 'Schlafen',
    mapCookies:
        'Um die Karte anzeigen zu können, muss der <%privacy%> zugestimmt werden. Ansonsten kann ebenfalls der folgende <%link%> aufgerufen werden.',
    mapPrivacy: 'Datenschutzerklärung',
    mapLink: 'Link',
    ...
    emailAccomodationType: 'Art der Übernachtung',
    emailFoodIntolerance: 'Lebensmittelunverträglichkeiten',
    emailPleaseComplete: 'Bitte ausfüllen',
    emailYesNo: 'Ja/Nein',
    emailSingleDoubleRoom: 'Einzel- oder Doppelzimmer',
...
const en: Dictionary = {
    ...
    titleSleep: 'Sleep',
    mapCookies: 'To view the map, you must agree to the <%privacy%>. Otherwise you can also use the following <%link%>.',
    mapPrivacy: 'privacy policy',
    mapLink: 'link',
    mapAccept: 'View map',
    ...
    emailAccomodationType: 'Type of accomodation',
    emailFoodIntolerance: 'Food intolerance',
    emailPleaseComplete: 'Please complete',
    emailYesNo: 'Yes/No',
    emailSingleDoubleRoom: 'Single or double room',
