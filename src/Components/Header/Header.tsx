                ...
                <div id='left'>
                    <Link to='/'>
                        {this.props.browser.device === 'Desktop' ? (
                            <svg id='logo' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 250'>
                                <defs>
                            ...
                            <img id='logo' src='assets/svg/logo_picture.svg' />
                        )}
                    </Link>
                </div>
                <div id='right'>
                    <div id='language' onClick={() => this.props.handleLanguage(this.props.browser.language === 'de' ? 'en' : 'de')}>
                        {this.props.browser.device === 'Desktop' ? (
                            this.props.browser.language === 'de' ? (
                                <svg id='english' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 25 15'>
                                    <line id='english_01' x1='.91' y1='7' x2='6.52' y2='7' />
                                    <polyline id='english_02' points='6.67 2.36 .91 2.36 .91 12.72 6.67 12.72' />
                                    <polyline id='english_03' points='11.97 13.58 11.97 2.88 20.75 12.05 20.75 1.51' />
                                </svg>
                            ) : (
                                <svg id='german' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 25 15'>
                                    <path
                                        id='german_01'
                                        d='m2.28,1.53v11.2c.28,0,.98,0,1.75,0,2.1,0,5.83-.79,5.83-5.35,0-4.19-3.7-5.02-5.83-5.02-.51,0-2.27,0-2.59,0'
                                    />
                                    <line id='german_02' x1='16.45' y1='7.01' x2='22.07' y2='7.01' />
                                    <polyline id='german_03' points='22.21 2.36 16.45 2.36 16.45 12.73 22.21 12.73' />
                                </svg>
                            )
                        ) : (
